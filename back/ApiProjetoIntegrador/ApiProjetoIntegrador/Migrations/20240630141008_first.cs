        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Itens_Doadores_DoadorId",
                        column: x => x.DoadorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonatarioId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    DataDoacao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Quantidade = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensDoados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItensDoados_Donatarios_DonatarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Itens_DoadorId",
                table: "Itens",
                column: "DoadorId");

            migrationBuilder.CreateIndex(
                name: "IX_ItensDoados_DonatarioId",
                table: "ItensDoados",
                column: "DonatarioId");
        }
